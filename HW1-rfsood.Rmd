...
# Join the tables using two right-joins
DT <- merge(x = merge(x = gse, y = gse_gpl, by = "gse", all.y=TRUE), y = gpl, by = "gpl", all.y=TRUE)

# Return rows where title contains "Hepatitis C", contact contains "Yale", and manufacturer contains "Illumina"
DT[title %like% "Hepatitis C"][contact %like% "Yale"][manufacturer %like% "Illumina"]
```
